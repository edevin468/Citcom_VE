...
struct VISC_OPT {
    ...
    float zlith;
    int YIELD_STRESS;
    float cohesion,friction_coef,alpha,beta;

    float work_done,work_done_total,elastic,elastic_total,dissipation,dissipation_total,dissipation_total_old,*dissipation_e,*dissipation_n,*element,*element1;
    ...
    float sdepv_misfit;
    int sdepv_normalize;
    float sdepv_bg[40];          /* added 11/22/02 */
    float sdepv_expt[40];
    float sdepv_trns[40];
